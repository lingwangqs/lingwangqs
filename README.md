# Hi, my name is Ling Wang. I am a theoretical physicist specializing in simulation.
...
# Interests
I use machine learning, matrix product states, tensor network states, etc. techniques to simulate quantum and classical statistics and dynamics in high dimensions. 
...
- Symmetrizing Neural Quantum States (NQS) algorithm, preserving lattice symmetries, spin inversion, and total spin conservation symmetries
  in a way that is efficient both in computational time and memory. [code repository](https://github.com/lingwangqs/lattice_symmetries)
  - [Physical Review B **111** L161116 (2025)](https://journals.aps.org/prb/abstract/10.1103/PhysRevB.111.L161116)
- Implimenting an SU(2) spin rotational symmetric Density Matrix Renormalization Group (DMRG) algorithm. [code repository](https://github.com/lingwangqs/symmetry-adapted-DMRG-library)
...
- Implementing an exact diagonalization (ED) algorithm for 2-dimensional quantum systems, preserving lattice symmetries, spin inversion, and total spin conservation symmetries. [code repository](https://github.com/lingwangqs/lattice_symmetries)
  - [Phys. Rev. B **110**, 224404 (2024)](https://journals.aps.org/prb/abstract/10.1103/PhysRevB.110.224404)
